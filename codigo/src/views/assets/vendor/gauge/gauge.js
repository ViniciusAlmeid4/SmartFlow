(function() {
    ...
    (function() {
        ...
        for (_i = 0,
        _len = vendors.length; _i < _len; _i++) {
            vendor = vendors[_i];
    ...
    String.prototype.hashCode = function() {
        ...
        for (i = _i = 0,
        _ref = this.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    AnimatedTextFactory = {
        create: function(objList) {
            ...
            out = [];
            for (_i = 0,
            _len = objList.length; _i < _len; _i++) {
                elem = objList[_i];
    ...
    Gauge = (function(_super) {
        ...
        Gauge.prototype.configPercentColors = function() {
            ...
            if (this.options.percentColors !== void 0) {
                ...
                _results = [];
                for (i = _i = 0,
                _ref1 = this.options.percentColors.length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
        ...
        Gauge.prototype.set = function(value) {
            ...
            if (value.length > this.gp.length) {
                for (i = _i = 0,
                _ref1 = value.length - this.gp.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
        ...
        Gauge.prototype.getColorForPercentage = function(pct, grad) {
            ...
            if (pct === 0) {
                ...
                for (i = _i = 0,
                _ref1 = this.percentColors.length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
